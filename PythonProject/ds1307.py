...
class DS1307(object):
    ...
    def __init__(self, i2c, addr=0x68):
        ...
        self._halt = False
        self.month_transfer_arr = [31,59,90,120,151,181,212,243,273,304,334]
    ...
    def datetime_seconds(self):
        ...
        total_seconds += (time[0] - 1970) * 31536000
        if time[1] > 1:
            total_seconds += self.month_transfer_arr[time[1] - 2] * 86400 # MONTHS
        total_seconds += (time[2] - 1) * 86400 #DAYS
        total_seconds += time[4] * 3600 #HOURS
        total_seconds += time[5] * 60 #MINUTES
        total_seconds += time[6] #SECONDS
